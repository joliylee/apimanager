...
<header>
	<div class="container navi-breadcrumb">
		<ul class="breadcrumb">
	        ...
	        <li><a class="active" href="<?php echo U('interface/create');?>?projectid=<?php echo ($projectData["id"]); ?>">新建接口</a></li>
...
<div class="container">
	<form id="createinterface" action="<?php echo U('interface/create');?>" method="post">
		...
		<select id="http-type-select" name="http_type">
			<?php if(is_array($httpStatus)): foreach($httpStatus as $k=>$vo): ?><option value="<?php echo ($k); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
		</select>
		<label for="">所属类别</label>
		<select name="category_id">
			<?php if(is_array($categoryData)): foreach($categoryData as $k=>$vo): ?><option value="<?php echo ($k); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
